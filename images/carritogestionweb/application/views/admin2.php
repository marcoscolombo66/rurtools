            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <ul class="nav navbar-right navbar-top-links">
                    ...
                    <li class="dropdown">
                        ...
                        <li>
                            <a href="<?php echo site_url('admin/terminos/edit/0')?>" class="active">
							<i class="fa fa-legal fa-fw"></i> TERMINOS</a>
                        </li>
						<li>
                        ...
                        <li>
							...
							<i class="fa fa-briefcase fa-fw"></i> PRODUCTOS TANGO</a>
                        </li>
                            <li>
...
var url = "https://gestionst.com.ar/quebracho/Admin/coloresProductos/add/?idProducto=" + idProducto;
