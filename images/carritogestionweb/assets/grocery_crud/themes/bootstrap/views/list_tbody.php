        ...
        <td <?php if ($unset_delete) { ?> style="border-left: none;"<?php } ?>
            <?php if ($buttons_counter === 0) {?>class="hidden"<?php }?>>
                <div class="only-desktops"  style="white-space: nowrap">
					...
					<?php if(!$unset_clone){?> 
                        <a class="btn btn-default" href="<?php echo $row->clone_url?>"><i class="fa fa-pencil"></i> <?php echo $this->l('list_clone'); ?></a>
                    <?php } ?>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="<?php echo $row->clone_url?>">
                                    <i class="fa fa-pencil"></i> <?php echo $this->l('list_clone'); ?>
                                </a>
                            </li>
                            <?php } ?>
                            <?php
