<nav class="navbar navbar-dark bg_grisoscuro shadow-sm navbar-expand-lg" style="text-align:right;background-color:#ffffff;"> <!-- Nav-->
  <div class="container"> 
  <img src="<?php echo $urlAdmin;?>images/logo_top_new.png" alt="Logo institucional" height="50">
...
data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="background-color:#ffffff;">Iniciar sesión</a>
          <div class="dropdown-menu text-center" aria-labelledby="submenu">
            <form class="" method="post" action="<?php echo 'https://www.libreviaje.com/';?>admin/LoginPilotos/validar_form" id="formlogin">
              <input class="form_login boxshadow" name="txtUsuario" type="email" id="txtUsuario" placeholder="Email o nombre de usuario">
            ...
            <div class="opciones"> <small><a href="<?php echo 'https://www.libreviaje.com/';?>admin/Olvido">¿Olvidaste tu contrase&ntilde;a?</a><br>
              </small> <small>¿No t&eacute;nes cuenta? <a href="<?php echo 'https://www.libreviaje.com/';?>admin/RegistroPilotos">Registrate</a></small> </div>
          </div>
        </li> 
        <li class="nav-item"><a class="nav-link" href="<?php echo 'https://www.libreviaje.com/';?>admin/Olvido">¿Olvidaste tu contraseña?</a></li>
