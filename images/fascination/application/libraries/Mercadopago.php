...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    $config['ci'] = $preference_data['MPAGO_Client_ID'];
    $config['cs'] = $preference_data['MPAGO_Client_Secret']; 
	 ///Modo sandbox
    $config['public_key_sandbox'] = 'TEST-****';
    $config['access_token_sandbox'] ='TEST-******';
	///Modo Producción
    $config['public_key_production'] = $preference_data['MPAGO_Public_Key'];
    $config['access_token_production'] = $preference_data['MPAGO_Access_Token']; 
